...
struct Int4llamaAttention_input {
    ...
    Int4llamaAttention_input(Matrix3D<half> hidden_states_, Matrix3D<half> attention_mask_, int layer_idx_)
        : hidden_states(hidden_states_), attention_mask(attention_mask_), layer_idx(layer_idx_) {}

    Int4llamaAttention_input(Matrix3D<half> hidden_states_, Matrix3D<half> attention_mask_, Matrix3D<half> past_key_,
