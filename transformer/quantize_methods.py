...
def quantize_row_q4_0(input_path, k, data_type, cuda_is_available, input_channel, output_channel):
...
def quantize_row_q4_1(input_path, k, data_type, cuda_is_available, input_channel, output_channel):
...
def quantize_row_q4_2(input_path, k, data_type, cuda_is_available, input_channel, output_channel):
...
def quantize_row_q4_3(input_path, k, data_type, cuda_is_available, input_channel, output_channel):
...
def quantize_row_q4_4(input_path, k, data_type, cuda_is_available, input_channel, output_channel):
    """Quantize the row to the following format.
