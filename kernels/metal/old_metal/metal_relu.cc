...
namespace matmul {
void MatmulOperator::relu_metal(const struct matmul_params *params, unsigned int m_dim_x, unsigned int m_dim_y, unsigned int m_dim_z){
    int i, j, k;
    ...
    MetalIMP::run_relu(matmulparams, &bufferparams);
};
}