...
void MatmulOperatorRef::mat_mul_accelerator_int8_fast_2x2_32unroll(const struct matmul_params *params) {
    int8_ref_matmul(params);
}

void MatmulOperatorRef::mat_mul_accelerator_int8_fast_2x2_32unroll_nobias(const struct matmul_params *params) {
    int8_ref_matmul_nobias(params);
}

void MatmulOperatorRef::mat_mul_accelerator_int8_fast_2x2_32unroll_nobias_batch(const struct matmul_params *params) {
    int8_ref_matmul_nobias_batch(params);
}

void MatmulOperatorRef::mat_mul_accelerator_int8_fast_32unroll_over_column(const struct matmul_params *params) {
    int8_ref_matmul(params);
}

void MatmulOperatorRef::mat_mul_accelerator_int8_fast_2x2_32unroll_bfp32_ofp32(const struct matmul_params *params) {
    int8_ref_matmul_bfp32_ofp32(params);
}

void MatmulOperatorRef::mat_mul_accelerator_int8_fast_2x2_32unroll_nobias_ofp32(const struct matmul_params *params) {
    int8_ref_matmul_nobias_ofp32(params);
}

void MatmulOperatorRef::mat_mul_accelerator_int8_fast_2x2_32unroll_nobias_ofp32_batch(const struct matmul_params *params) {
